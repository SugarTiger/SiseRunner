...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url('resource/index/css'); ?>/bootstrap.min.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('resource/index/css'); ?>/index.css"/>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('resource/index/css'); ?>/SiseRunHome.css" />
		<script src="<?php echo base_url('resource/index/js'); ?>/respond.js" type="text/javascript" charset="utf-8"></script>
						...
						<div id="box" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img src="<?php echo base_url('resource/index/img'); ?>/spot2.jpg" alt="First slide">
									<div class="carousel-caption">
										<p>广东省教职工马拉松健跑活动基地落户华软学院</p>
									</div>
								</div>
								<div class="item">
									<img src="<?php echo base_url('resource/index/img'); ?>/run.jpg" alt="Second slide">
									<div class="carousel-caption">
										<p>厦门马拉松开启</p>
									</div>
								</div>
								<div class="item">
									<img src="<?php echo base_url('resource/index/img'); ?>/run1.jpg" alt="Third slide">
									<div class="carousel-caption">
										<p>2017年深圳马拉松正式启动</p>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="run-info">
							...
							<div id="information" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner">
									<div class="item active">
										<img src="<?php echo base_url('resource/index/img'); ?>/spot.jpg" alt="First slide">
									</div>
									<div class="item">
										<img src="<?php echo base_url('resource/index/img'); ?>/spot1.jpg" alt="Second slide">
									</div>
									<div class="item">
										<img src="<?php echo base_url('resource/index/img'); ?>/1.jpg" alt="Third slide">
									</div>
								</div>
								<!-- 轮播（Carousel）导航 -->
					...
					<div class="col-md-4 col-sm-6">
						<div class="run-info">
							...
							<a href="story.html">
								<div class="story-pic"><img src="<?php echo base_url('resource/index/img'); ?>/story.jpg" /></div>
				...
				<div class="row">
						...
						<div class="appiontment">
							...
							<div style="height: 230px;">
								<div  id="image1" class="img-h">
									<img src="<?php echo base_url('resource/index/img'); ?>/ap1.jpg" />
									<div class="ap-1">
									<p>发布：sussie</p>
									<p> 时间：2017-1-10</p>
									<p>地点：东门广场</p>
					...
					<div class="col-xs-12 col-md-6 col-sm-12">
							...
							<a href="onlinerun.html" class="thumbnail remove">
								<img alt="线上马拉松" src="<?php echo base_url('resource/index/img'); ?>/online.jpg">
							...
							<div  class="row h-guidence2" >
									<div class="col-md-6 col-sm-12">
										<div class="baike" >
											<h4>跑步百科</h4>
											<div class="col-md-6 col-sm-12" >
												<img src="<?php echo base_url('resource/index/img'); ?>/baike.jpg"  width="100%" />
											</div>
											<div class="col-md-6 col-sm-12" >
												<ul>
									...
									<div class="col-md-6 col-sm-12" >
										<div class="b-point" >
											...
											<div class="col-md-6 col-sm-3" >
												<img src="<?php echo base_url('resource/index/img'); ?>/point.jpg" width="100%"/>
											</div>
											<div class="col-md-6 col-sm-3">
												<ul >
...
<div class="loginbox" id="login">
    <img src="<?php echo base_url('resource/index/img'); ?>/wlogo.png" class="lblogo">
