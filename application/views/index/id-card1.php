...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('resource/index/css'); ?>/ap-css.css"/>
		...
		<script type="text/javascript" src="./<?php echo base_url('resource/index/js'); ?>/edit.js"></script>
				...
				<div id="p-right1"  >
				    	...
				    	<section class="first_content" style="display: none;">
							...
							<div class="row">
	                            ...
	                            <div class="col-md-6" >
	                            	<img src="<?php echo base_url('resource/index/img'); ?>/body.jpg"/>
	                            </div>
	                          </div>
	                           <div class="row" >
				                     	<div class="col-md-12">
