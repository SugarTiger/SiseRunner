...
class Form {
	...
	public static function editor($textareaid = 'content', $toolbar = 'basic', $height = 200, $color = '', $up=true) {
		...
		if(!defined('EDITOR_INIT')) {
			$str = '<script type="text/javascript" src='."<?php echo base_url('resource/index/public'); ?>/ckeditor/ckeditor.js".'></script>';
	...
	public static function date($name, $value = '', $isdatetime = 0, $loadjs = 0) {
		...
		if($loadjs || !defined('CALENDAR_INIT')) {
			...
			$str .= '<script src='.
					"<?php echo base_url('resource/index/public'); ?>/js/date/js/jscal2.js".
					'></script><script src='.
					"<?php echo base_url('resource/index/public'); ?>/js/date/js/lang/cn.js".
					'></script><link rel="stylesheet" type="text/css" href='.
					"<?php echo base_url('resource/index/public'); ?>/js/date/css/jscal2.css".
					'/><link rel="stylesheet" type="text/css" href='.
					"<?php echo base_url('resource/index/public'); ?>/js/date/css/border-radius.css".
					'/><link rel="stylesheet" type="text/css" href='.
					"<?php echo base_url('resource/index/public'); ?>/js/date/css/steel/steel.css".' />';
		}
	...
	public static function color($name, $value = '000000') {
		...
		if(!defined('COLOR_INIT')) {
			define('COLOR_INIT', 1);
			$str= '<script src='."<?php echo base_url('resource/index/public'); ?>/js/jscolor/jscolor.js".'></script>';
